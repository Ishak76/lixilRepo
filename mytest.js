...
app.get("/Project-Details", function (req, res) {
    ...
    request.query(query, function (err, Result) {
        ...
        var tvp_FilterColumns = new sql.Table();
        var filterobj = request.body.name;
        // Columns must correspond with type we have created in database.   
       
        tvp_FilterColumns.columns.add('FilterColumn', sql.NVarChar(1000));
        tvp_FilterColumns.columns.add('FilterText', sql.NVarChar(max));  
        tvp_FilterColumns.columns.add('columnDataType', sql.NVarChar(100));  


          
      for(var object in filterobj) {
        tvp_FilterColumns.rows.add(object.columnname, object.columnvalue); }

       request.input('FilterColumns', tvp_FilterColumns);
...
app.post("/filter-project", function (req, res) {
    ...
    //    console.log(req.body)['projectname'];
      ...
      for(var object in filterobj) {
        ...
        // console.log(Object.keys(filterobj[object]))
        // console.log(Object.values(filterobj[object]))
       ...
       //request.parameters.add('FilterColumnsTable', sql.TYPES.TVP, tvp_FilterColumns);
