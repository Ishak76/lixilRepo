...
app.post("/ClientContactMasterFilter", function (req, res) {

    var query = "usp_GetClientContactMasterFilter";
    ...
    request.execute('usp_GetClientContactMasterFilter', function (err, recordsets) {
